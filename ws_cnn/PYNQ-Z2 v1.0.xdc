...
#set_input_delay -clock [get_clocks *] 0.0 [get_ports {en {inp[0]} {inp[1]} {inp[2]} {inp[3]} {inp[4]} {inp[5]} {inp[6]} {inp[7]} {inp[8]} {inp[9]}}]
#set_output_delay -clock [get_clocks *] -add_delay 0.0 [get_ports -filter { NAME =~  "*" && DIRECTION == "OUT" }]
